/*
* @Author: 52jwl
* @Date:   2018-09-03 11:33:45
* @Last Modified by:   52jwl
* @Last Modified time: 2018-09-03 11:34:03
*/

'use strict';


  // <canvas id="love" style="position: fixed;z-index: 999;transform: translate3d(0,0,0);left:0;top:0;"></canvas>
  // <script type="text/javascript">


    // Initial Setup
    var canvas = document.querySelector('#love');
    ...
    var colors =  ["#FD1811", "#F54B45", "#F68D0C", "#ECF00F", "#91C878", "#00B9D2"];
    // Event Listeners
